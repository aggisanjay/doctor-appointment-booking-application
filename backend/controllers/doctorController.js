...
const appointmentComplete=async(req,res)=>{
    try {
        ...
        if(appointmentData && appointmentData.docId===req.docId ){
...
export {changeAvaliability,doctorList,loginDoctor,appointmentsDoctor,appointmentCancel,appointmentComplete,DoctorDashboard,doctorProfile,updateDoctorProfile}